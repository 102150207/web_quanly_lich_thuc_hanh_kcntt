					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<?php
									...
									if($data =="")
									{
										header("location:TimKiemGV.php");
									} else if($pt == "t1") {
											$link  = mysql_connect("localhost","root","") or die ("Khong the ket noi CSDL");
											//$db_selected = ;
											mysql_select_db("final",$link);
											$sql = "select * from giaovien";
											$result  = mysql_query("SELECT * FROM giaovien Where TenGV = '".$data."' or MaGV = '".$data."' "); 
									...
									echo '<tr><td>'.$i.'</td> 
												...
												<td><a  style = "color : red " href="xulyTimKiemChiTietGV.php?id='.$row1['MaGV'].'">xxx</a></td></tr>';
										$i++;
										}
									echo '</table>';
									...
									echo '<tr><td>'.$i.'</td> 
												<td>'.$row1['TenGV'].'</td> <td>'.$row1['MaGV'].'</td> 
												<td><a href="xulyTimKiemChiTietGV.php?id='.$row1['MaGV'].'">xxx</a></td></tr>';
										$i++;
										}
									echo '</table>';
