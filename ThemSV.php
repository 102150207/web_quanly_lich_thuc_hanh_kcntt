				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<h4 style = "color : blue"> <strong> Thông Tin Sinh Viên Khoa CNTT </strong></h4>
							<?php 
								 $masv = $tensv = $ngaysinh = $diachi = $malop = $gioitinh =  "";
								// nếu tồn tại ok thì check điều kiện
								if(isset($_POST['ok'])){
									if($_POST['masv'] == ""){
										$errormasv = "Vui lòng nhập lại mã sinh viên !";
									}else{
										$masv = $_POST['masv'];
									}
									if($_POST['tensv'] == ""){
										$errorten = "Vui lòng nhập lại tên sinh viên !";
									}else{
										$tensv = $_POST['tensv'];
									}
									if($_POST['ngaysinh'] == ""){
										$errorngaysinh = "Vui lòng nhập lại ngày sinh sinh viên !";
									}else{
										$ngaysinh = $_POST['ngaysinh'];
									}
									if($_POST['diachi'] == ""){
										$errordiachi = "Vui lòng nhập lại địa chỉ sinh sinh viên !";
									}else{
										$diachi = $_POST['diachi'];
									}
									if($_POST['malop'] == ""){
									...
									if( ! isset($_POST['gioitinh'])){
										$errorgioitinh = "Vui lòng nhập lại giới tính sinh viên !";
									}else{
									...
									$link = mysql_connect("localhost","root","") or die ("Khong the ket noi CSDL");
										...
										while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
											if($masv == $row['MaSV']){
												echo '<span style = "color : red"> "Mã Giao Viên đã tồn tại, vui lòng nhập lại mã giáo viên khác ..."</span>';
												break;
											}
											else {
												if( $masv && $tensv && $malop && $ngaysinh && $diachi  && $gioitinh){
														$sqlinsert = "INSERT INTO sinhvien 
														values ( '".$masv."', '".$tensv."', '".$malop."', '".$ngaysinh."',  '".$gioitinh."',  '".$diachi."' )";
														mysql_query($sqlinsert);				
														header("location:Suaxemthongtinsinhvien.php");
													}
											}
										}
									...
									<br><br>
											<table>
												<tr> 
													...
													<td><input type="text" name ="masv" value = "sv00"/></td>
													<td style ="color:red"><?php echo isset($errormasv) ? $errormasv: "" ?></td>
												</tr>
												<tr> 
													<td><span>Tên Sinh Viên :</span></td>
													<td><input type="text" name ="tensv" value = ""/></td>
												...
												<tr> 
													...
													<td colspan="2"  >
														...
														Nũ <input type="radio" name = "gioitinh"  
															...
															value = "Nu"
														/>
														<span style ="color:red"><?php echo isset($errorgioitinh) ? $errorgioitinh : "" ?></span>
													<td>
													<td></td>
												</tr>
												<tr> 
												...
												<tr> 
													<td><span>Địa Chỉ Sinh Viên : </span></td>
