					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<?php 
								...
								$sql = "SELECT * FROM sinhvien WHERE MaSV = '".$s."'";
								$rs = mysql_query($sql,$link);
								$row = mysql_fetch_assoc($rs);
								echo '<table style = "color : blue " border ="1" width = "100%">';
									echo '<h1><caption> Du Lieu truy xuat tu bang Sinh Vien </caption></h1>';
									echo '<tr><th>Ma So</th><th>Ho Ten</th><th>Ma Lop</th>
									<th>Ngay Sinh</th><th>Gioi Tinh</th><th>Dia Chi</th></tr>';
										echo '<tr><td>'.$s.'</td> <td>'.$row['TenSV'].'</td>
										<td>'.$row['MaLop'].'</td>
										<td>'.$row['NgaySinh'].'</td><td>'.$row['GioiTinh'].'</td>
										<td>'.$row['DiaChi'].'</td> 
