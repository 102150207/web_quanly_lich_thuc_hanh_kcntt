					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<?php 
								...
								//////
								 $tensv = $ngaysinh = $diachi = $malop = $gioitinh =  "";
								...
								if(isset($_POST['ok'])){
									...
									if( $tensv && $malop && $ngaysinh && $diachi  && $gioitinh){
										...
										header("location:suatrangcanhanSV.php");
									}
								}
							...
							<br><br>
									<table>
										...
										<tr> 
											...
											<td><input type="text" name ="tensv" value = "<?php echo $data['TenSV']?>"/></td>
											<td style ="color:red"><?php echo isset($errorten) ? $errorten : "" ?></td>
										</tr>
										<tr> 
											<td><span>Mã Lớp : </span></td>
											<td><input type="text" name = "malop" value = "<?php echo $data['MaLop']?>"/></td>
					...
					<ul id="menu" >
						...
						<li id="menu-academico" ><a href=""><i class="fa fa-cogs" aria-hidden="true"></i><span>Đăng Nhập</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
							<ul id="menu-academico-sub" >
								...
								<li id="menu-academico-avaliacoes" ><a href="formdangnhapQL.php">Giao Viên</a></li>
