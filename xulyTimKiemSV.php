					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<?php
								...
								if($data =="")
								{
									header("location:TimKiemSV.php");
								} else if($pt == "t1") {
										$link  = mysql_connect("localhost","root","") or die ("Khong the ket noi CSDL");
										//$db_selected = ;
										mysql_select_db("final",$link);
										$sql = "select TenSV, MaSV from sinhvien";
										$result  = mysql_query("SELECT * FROM sinhvien Where TenSV = '".$data."' or MaLop = '".$data."' "); 
								...
								echo '<tr><td>'.$i.'</td> 
											...
											<td><a style = "color : red " href="xulyTimKiemChiTietSV.php?id='.$row1['MaSV'].'">xxx</a></td></tr>';
									$i++;
									}
								echo '</table>';
									...
									$link  = mysql_connect("localhost","root","") or die ("Khong the ket noi CSDL");
										...
										$result  = mysql_query("SELECT * FROM sinhvien Where DiaChi = '".$data."' "); 
								...
								echo '<tr><td>'.$i.'</td> 
											<td>'.$row1['TenSV'].'</td> <td>'.$row1['MaSV'].'</td> 
											<td><a href="xulyTimKiemChiTietSV.php?id='.$row1['MaSV'].'">xxx</a></td></tr>';
									$i++;
									}
								echo '</table>';
