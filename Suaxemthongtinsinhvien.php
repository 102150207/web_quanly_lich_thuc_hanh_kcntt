				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<h4 style = "color : blue"><strong> Thông Tin Tất Cả Các Sinh Viên Hành Khoa CNTT </strong></h4>
							<?php 
								...
								echo '<table border ="1" width = "100%"  style = "color : blue">';
									...
									echo '<tr><th>Ma Sinh Viên</th><th>Ten Sinh Viên</th><th>Mã Lớp</th>
									<th>Ngày Sinh</th><th>Gioi Tính</th><th>Địa Chỉ</th>
									<th>Update</th></tr>';
									while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
										echo '<tr><td>'.$row['MaSV'].'</td> <td>'.$row['TenSV'].'</td> 
										<td>'.$row['MaLop'].'</td> <td>'.$row['NgaySinh'].'</td> <td>'.$row['GioiTinh'].'</td>
										<td>'.$row['DiaChi'].'</td> 
										<td><a style = "color : red" href="FormsuathongtinSV.php?id='.$row['MaSV'].'">xxxxx</a></td>
										</tr>';
									}
								echo '</table>';
