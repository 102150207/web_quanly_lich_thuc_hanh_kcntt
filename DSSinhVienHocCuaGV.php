					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<?php 
								...
								$sql = "SELECT sinhvien.TenSV,  sinhvien.MaSV,
								sinhvien.NgaySinh, sinhvien.GioiTinh, sinhvien.DiaChi
								...
								where giaovien.MaGV = '".$s."' and sinhvien.MaLop= '".$x."' ";
								$a = mysql_query($sql,$link); 
								
							echo '<table  style = "color : blue "  border ="1" width = "100%">';
									echo '<h1><caption> Danh Sach Lop  </caption></h1>';
									echo '<tr><th>STT </th><th>Ho Ten</th><th>Ma So SV</th>
									<th>Ngay Sinh</th><th>Gioi Tinh</th><th>Dia Chi</th></tr>';
									$i = 1;
								while($row1 = mysql_fetch_array($a, MYSQL_BOTH)){
							echo '<tr><td>'.$i.'</td> 
										<td>'.$row1['TenSV'].'</td> <td>'.$row1['MaSV'].'</td>
										<td>'.$row1['NgaySinh'].'</td><td>'.$row1['GioiTinh'].'</td> 
										<td>'.$row1['DiaChi'].'</td> </tr>';
								$i++;
								}
							echo '</table>';
					...
					<ul id="menu" >
						...
						<li id="menu-academico" ><a href=""><i class="fa fa-cogs" aria-hidden="true"></i><span>Đăng Nhập</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
							<ul id="menu-academico-sub" >
								<li id="menu-academico-avaliacoes" ><a href="">Quản Lý</a></li>
