								...
								<div class="main-wthree">
									<div class="container">
										<div class="sin-w3-agile">
											<h2>ĐĂNG NHẬP CHO SINH VIÊN </h2>
											<form action="xulyloginSV.php" method="post">
												<div class="username">
													<span class="username">Username:</span>
													<input type="text" name="t1" class="name" value = "sv001" placeholder="" required="">
													<div class="clearfix"></div>
												</div>
												<div class="password-agileits">
													<span class="username">Password:</span>
													<input type="password" name="t2" class="password" value = "trinhhung" placeholder="" required="">
													<div class="clearfix"></div>
												</div>
												<div class="login-w3">
