						...
						<div class="agileits-box">
							...
							<?php 
								...
								echo '<table style = "color : blue " border ="1" width = "100%">';
									...
									<th>Ngay Sinh</th><th>Gioi Tinh</th><th>Dia Chi</th><th>Update</th></tr>';
										echo '<tr><td>'.$_SESSION['id'].'</td> <td>'.$row['TenSV'].'</td>
										<td>'.$row['MaLop'].'</td>
										<td>'.$row['NgaySinh'].'</td><td>'.$row['GioiTinh'].'</td>
										<td>'.$row['DiaChi'].'</td> 
										
										<td><a style = "color : red " href="FormsuathongtincanhanSV.php?id='.$row['MaSV'].'">xxx</a></td>
										</tr>';
