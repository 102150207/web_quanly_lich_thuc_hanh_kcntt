				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<h4 style = "color : blue"> <strong> Thông Tin Giao Viên Khoa CNTT </strong></h4>
							<?php 
								$magv1 = $tengv1 = $ngaysinh1 = $diachi1 = $dienthoai1 = $gioitinh1 =  "";
								// nếu tồn tại ok thì check điều kiện
								if(isset($_POST['ok'])){
									if($_REQUEST['magv'] == ""){
										$errormagv = "Vui lòng nhập lại tên giáo viên !";
									}else{
										$magv1 = $_REQUEST['magv'];
									}
									if($_REQUEST['tengv'] == ""){
									...
									while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
										if($magv1 == $row['MaGV']){
											...
											if( $magv1 && $tengv1 && $ngaysinh1 && $diachi1 && $dienthoai1 && $gioitinh1){
												$sqlinsert = "INSERT INTO  giaovien 
												values ( '".$magv1."' , '".$tengv1."' , '".$gioitinh1."' , '".$ngaysinh1."',
													'".$diachi1."' , '".$dienthoai1."' )";
		...
		<br><br>
				<table>
					...
					<tr> 
						...
						<td><input type="text" name ="tengv" value = ""/></td>
					...
					<tr> 
						...
						<td colspan="2" class = "error" >
							...
							/>
							Nũ <input type="radio" name = "gioitinh"  value = "Nu"
							/>
