				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<br /> 
							<br />
							<form  style = "color : blue " class ="center1" name = "form1" action = "xulyTimKiemGV.php"  method = "POST" >
								<table>
									<tr> 
										<td><span>Tim Kiem Theo:</span></td>
										<td><Select Name="select_name"  >
											<option value ="t1"> Ten GV hoac Ma GV </option>
											<option value ="t2"> Dia Chi Giao Vien  </option>
											</select>
										</td>
