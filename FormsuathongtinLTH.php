					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<?php 
								...
								$sql = "SELECT * FROM lichthuchanh WHERE MaLTH = '".$id."'";
								$rs = mysql_query($sql,$link);
								$data = mysql_fetch_assoc($rs);
								$thu = $ngaybatdau = $sotuanthuchanh  =  "";
								...
								if(isset($_POST['ok'])){
									...
									if( $thu && $ngaybatdau && $sotuanthuchanh ){
										$sqlupdate = "Update lichthuchanh Set 
										Thu = '".$thu."'
										,NgayBatDau = '".$ngaybatdau."'
										,SoTuanThucHanh = '".$sotuanthuchanh."'
										WHERE MaLTH = '".$id."' ";
								...
								<form style = "color : blue " action="" method = "POST">
									<br><br>
											<table>
												<tr> 
													<td><span>Thứ  :</span></td>
													<td><input type="text" name ="thu" value = "<?php echo $data['Thu']?>"/></td>
													<td style ="color:red"><?php echo isset($errorthu) ? $errorthu : "" ?></td>
												</tr>
												
												<tr> 
													<td><span>Ngày Bắt Đầu Học : </span></td>
													<td><input type="date" name = "ngayhoc"value = "<?php echo $data['NgayBatDau']?>"/></td>
													<td style ="color:red"><?php echo isset($errorngaybatdau) ? $errorngaybatdau : "" ?></td>
												</tr>
												<tr> 
													<td><span>Số Tuần Thực Hành : </span></td>
													<td><input type="text" name = "sotuan" value = "<?php echo $data['SoTuanThucHanh']?>"/></td>
												...
												<tr> 
													<td colspan="3">
														...
														<input style ="color:red" type="button" value="exit" onclick="exit()"/>
													</td>
												</tr>
											</table>
								</form>
					...
					<ul id="menu" >
						...
						<li id="menu-academico" ><a href=""><i class="fa fa-cogs" aria-hidden="true"></i><span>Thêm  Thông Tin</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
							<ul id="menu-academico-sub" >
								...
								<li id="menu-academico-avaliacoes" ><a href="">Giao Viên</a></li>
								<li id="menu-academico-avaliacoes" ><a href="">Sinh Viên</a></li>
								<li id="menu-academico-avaliacoes" ><a href="">Lớp Học</a></li>
								<li id="menu-academico-avaliacoes" ><a href="">Môn Học</a></li>
								<li id="menu-academico-avaliacoes" ><a href="">Lịch Thực Hành</a></li>
								<li id="menu-academico-avaliacoes" ><a href="">Phòng Học</a></li>
							</ul>
						</li>
