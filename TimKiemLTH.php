				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<br /> 
							<br />
							<form  style = "color : blue " class ="center1" name = "form1" action = "xulyTimKiemLTH.php"  method = "POST" >
								<br><br>
								<table>
									<tr> 
										<td><span>Tim Kiem Theo:</span></td>
										<td><Select Name="select_name"  >
											<option value ="t1"> Ma Lich Thuc Hanh hoặc Ten Mon Hoc </option>
											<option value ="t2"> Thu(2,3,4,5,6,7)  </option>
