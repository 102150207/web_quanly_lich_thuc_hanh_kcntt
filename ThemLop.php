				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<h4 style = "color : blue"> <strong> Thông Tin Các Lớp Khoa CNTT </strong></h4>
							<?php 
								...
								if(isset($_POST['ok'])){
									...
									if($_POST['tenlop'] == ""){
										$errortenlop = "Vui lòng nhập lại tên lớp !";
									}else{
										$tenlop = $_POST['tenlop'];
									}
									if($_POST['tongso'] == ""){
										$errortongso = "Vui lòng nhập lại số lượng lớp !";
									}else{
										$tongso = $_POST['tongso'];
									}
									...
									while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
										if($malop == $row['MaLop']){
											...
											if(  $malop && $tongso && $tenlop){
												$sqlinsert = "INSERT INTO  lop 
												values ( '".$malop."' , '".$tenlop."' , '".$tongso."' )";
									...
									if($dem == 0 ){
										header("location:xemthongtinlop.php");
									}else {
		...
		<br><br>
				<table>
					<tr> 
						...
						<td><input type="text" name ="malop" value = ""/></td>
						<td style ="color:red"><?php echo isset($errormalop) ? $errormalop : "" ?></td>
					</tr>
					<tr> 
						<td><span>Tên Lớp : </span></td>
						<td><input type="text" name = "tenlop" value = ""/></td>
						<td style ="color:red"><?php echo isset($errortenlop) ? $errortenlop : "" ?></td>
					</tr>
					<tr> 
						<td><span>Tổng Số : </span></td>
						<td><input type="text" name = "tongso" value = ""/></td>
						<td style ="color:red"><?php echo isset($errortongso) ? $errortongso : "" ?></td>
					</tr>
					<tr> 
						<td colspan="3">
