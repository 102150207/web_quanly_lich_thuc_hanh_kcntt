						...
						<div class="agileits-box">
							...
							<?php 
									...
									echo '<table style = "color : blue " border ="1" width = "100%">';
										...
										<th>Ngay Sinh</th><th>Dia Chi</th><th>So Dien Thoai</th><th>Update</th></tr>';
											echo '<tr><td>'.$_SESSION['id'].'</td> <td>'.$row['TenGV'].'</td>
											<td>'.$row['GioiTinh'].'</td>
											<td>'.$row['NgaySinh'].'</td><td>'.$row['DiaChi'].'</td>
											<td>'.$row['SoDT'].'</td> 
											
											<td><a style = "color : red " href="FormsuathongtincanhanGV.php?id='.$row['MaGV'].'">xxx</a></td>
											</tr>';
