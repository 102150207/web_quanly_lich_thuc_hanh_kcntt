								...
								<div class="main-wthree">
									<div class="container">
										<div class="sin-w3-agile">
											<h2>ĐĂNG NHẬP CHO GIÁO VIÊN </h2>
											<form  style = "color : blue " action="xulyloginGV.php" method="post">
												<div class="username">
													<span class="username">Username:</span>
													<input type="text" name="t1" class="name" value = "gv001" placeholder="" required="">
													<div class="clearfix"></div>
												</div>
												<div class="password-agileits">
													<span class="username">Password:</span>
													<input type="password" name="t2" class="password" value = "kiki" placeholder="" required="">
													<div class="clearfix"></div>
												</div>
												<div class="login-w3">
														<input type="submit" class="login" value="Sign In" name = "ok">
														<input class="login" type="button" name = "resect" value="Resect" onclick="xoa()"/>
												</div>
												<div class="clearfix"></div>
											</form>
