					...
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							echo '<table style = "color : blue " border ="1" width = "100%">';
									...
									<th>Tiet</th><th>Thu</th><th>Ngay Bat Dau</th><th>So Tuan Thuc Hanh</th><th>DS Hoc vien</th></tr>';
							...
							echo '<tr><td>'.$row1['TenMH'].'</td> 
										...
										<td>'.$row1['SoTuanThucHanh'].'</td><td><a style = "color : red "  href="DSSinhVienHocCuaGV.php?vt='.$row1['MaLop'].'">xxx</a></td> </tr>';
