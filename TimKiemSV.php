				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<br /> 
							<br />
							<form   style = "color : blue " class ="center1" name = "form1" action = "xulyTimKiemSV.php"  method = "POST" >
								<br><br>
								<table>
									<tr> 
										<td><span>Tim Kiem Theo:</span></td>
										<td><Select Name="select_name"  >
											<option value ="t1"> Ten SV hoac Ma Lop </option>
											<option value ="t2"> Dia Chi Sinh Vien </option>
