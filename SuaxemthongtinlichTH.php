				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<h4 style = "color : blue"><strong> Thông Tin Tất Cả Các Môn Thực Hành Khoa CNTT </strong></h4>
							<?php 
								...
								echo '<table border ="1" width = "100%"  style = "color : blue">';
									...
									echo '<tr><th>Ma Lịch Thực Hành</th><th>Ma Lớp</th><th>Ma Môn Học</th><th>Ma Giao Viên</th><th>Ma Phong</th>
									<th>Ma Thời Gian</th><th>Thứ</th><th>Ngày Bắt Đầu</th><th>Số Tuần Thực Hành</th>
									<th>Update</th></tr>';
									while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
										echo '<tr><td>'.$row['MaLTH'].'</td><td>'.$row['MaLop'].'</td><td>'.$row['MaMH'].'</td> <td>'.$row['MaGV'].'</td> 
										<td>'.$row['MaPHG'].'</td> <td>'.$row['MaTG'].'</td><td>'.$row['Thu'].'</td> <td>'.$row['NgayBatDau'].'</td>
										<td>'.$row['SoTuanThucHanh'].'</td> 
										<td><a style = "color : red" href="FormsuathongtinLTH.php?id='.$row['MaLTH'].'">xxxxx</a></td>
										</tr>';
									}
								echo '</table>';
