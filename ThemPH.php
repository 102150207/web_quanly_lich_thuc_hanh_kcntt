				...
				<!--trangchinhgiua-->
					<div class="agileinfo-grap">
						<div class="agileits-box">
							...
							<h4 style = "color : blue"> <strong> Thông Tin Phòng Học Khoa CNTT </strong></h4>
							<?php 
								...
								if(isset($_POST['ok'])){
									...
									if($_POST['maph'] == ""){
										$errormaph = "Vui lòng nhập lại tên giáo viên !";
									}else{
										$maph = $_POST['maph'];
									}
									if($_POST['tenph'] == ""){
										$errortenph = "Vui lòng nhập lại ngày sinh giáo viên !";
									}else{
										$tenph = $_POST['tenph'];
									}
									...
									if($dem == 0 ){
										header("location:xemthongtinphonghoc.php");
									}else {
										header("location:ThemPH.php");
									}
								...
								<form style = "color : blue " action="" method = "POST">
									<br><br>
											<table>
												...
												<tr> 
													<td><span>Mã Phòng : </span></td>
													<td><input type="text" name = "maph" value = "MP"/></td>
													<td style ="color:red"><?php echo isset($errormaph) ? $errormaph : "" ?></td>
												</tr>
												<tr> 
													<td><span>Tên Phòng : </span></td>
													<td><input type="text" name = "tenph" value = ""/></td>
													<td style ="color:red"><?php echo isset($errortenph) ? $errortenph : "" ?></td>
												</tr>
												<tr> 
													<td colspan="3">
