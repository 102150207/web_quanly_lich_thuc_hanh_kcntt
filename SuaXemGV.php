						...
						<div class="agileits-box">
							...
							<?php 
								...
								echo '<table border ="1" width = "100%"  style = "color : blue">';
									...
									<th>Ngay Sinh</th><th>SDT</th><th>Dia Chi</th><th>Update</th></tr>';
									while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
										echo '<tr><td>'.$row['MaGV'].'</td> <td>'.$row['TenGV'].'</td> 
										<td>'.$row['GioiTinh'].'</td> <td>'.$row['NgaySinh'].'</td>
										<td>'.$row['SoDT'].'</td><td>'.$row['DiaChi'].'</td> 
										<td><a style = "color : red" href="FormsuathongtinGV.php?id='.$row['MaGV'].'">xxxxx</a></td>
										</tr>';
									}
								echo '</table>';
