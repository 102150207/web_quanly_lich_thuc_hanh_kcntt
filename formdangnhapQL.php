								...
								<div class="main-wthree">
									<div class="container">
										<div class="sin-w3-agile">
											...
											<form action="xulyloginQL.php" method="post">
												<div class="username">
													<span class="username">Username:</span>
													<input type="text" name="t1" class="name" value = "ql001" placeholder="" required="">
													<div class="clearfix"></div>
												</div>
												<div class="password-agileits">
													<span class="username">Password:</span>
													<input type="password" name="t2" class="password" value = "huhu" placeholder="" required="">
													<div class="clearfix"></div>
												</div>
												<div class="login-w3">
