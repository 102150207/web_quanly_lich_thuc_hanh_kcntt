						...
						<div class="agileits-box">
							...
							<?php 
								...
								echo '<table border ="1" width = "100%"  style = "color : blue">';
									...
									echo '<tr><th>Ma Lớp</th><th>Tên Lớp </th><th>Tổng Số</th><th>Delete</th>
									</tr>';
									while($row = mysql_fetch_array($rs, MYSQL_BOTH)){
										echo '<tr><td>'.$row['MaLop'].'</td> <td>'.$row['TenLop'].'</td> 
										<td>'.$row['TongSo'].'</td> 
										<td><a style = "color : red" href="xulyxoaLop.php?id='.$row['MaLop'].'">xxxxx</a></td>
										</tr>';
									}
								echo '</table>';
